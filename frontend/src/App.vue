...
<template>
  <div class="flex flex-column h-full p-4 surface-100">
    ...
    <div class="flex-grow-1 flex flex-column pt-6 overflow-auto">
      <div class="flex flex-column lg:flex-row flex-wrap justify-content-center align-items-center gap-6">
        <FloatLabel>
        ...
        <FloatLabel>
          <Textarea class="pointer-events-none" v-model="textTranslated" rows="6" cols="35" autoResize readonly />
